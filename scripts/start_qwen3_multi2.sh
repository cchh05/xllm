...
LOG_FILE="$LOG_DIR/qwen3_multi2.log"
...
nohup "$XLLM_BIN" \
  ...
  --max_loras=16 \
  --max_lora_rank=32 \
  --lora_modules=taboo=/export/home/caihao.40/lora_adapters/qwen3-8b-taboo-ship,blue=/export/home/caihao.40/lora_adapters/qwen3-8b-blue \
