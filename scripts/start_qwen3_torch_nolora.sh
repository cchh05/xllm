#!/bin/bash
# P0-A M9: launch xllm with --enable_lora=false=true so the HTTP endpoints
...
echo "[INFO] launching Path C xllm on npu:0, port 18001, --enable_lora=false=true"
LOG_FILE="$LOG_DIR/qwen3_torch_nolora.log"
