...
LOG_DIR=/export/home/caihao.40/log_multilora/qwen3_30b_a3b_tp4_moe_strong
mkdir -p "$LOG_DIR"
...
START_DEVICE=0
START_PORT=18500
MASTER_ADDR=127.0.0.1:19500
HCCL_IF_BASE_PORT=44900
...
for i in 0 1 2 3; do
  ...
  setsid env \
    ...
    "${XLLM_BIN}" \
      ...
      --enable_lora=true \
      --lora_modules="moe=/export/home/caihao.40/lora_adapters/qwen3-30b-a3b-moe-strong" \
      --max_loras=16 \
      --max_lora_rank=8 \
